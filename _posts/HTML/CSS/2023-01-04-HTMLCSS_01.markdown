...
2. **반응형 구현 방법 (사용하는 단위, 브레이크포인트)**
   ...
   4. `미디어 쿼리` : 사용자 미디어의 종류와 상태에 대해 질의를 던져 기기의 종류나 화면 크기에 맞춰 개별적인 css 코드가 적욛될 수 있도록 하는 css3의 기능
      <details>
...
[미디어 쿼리](https://uxkm.io/publishing/css/03-cssMiddleclass/09-css_media_part2#gsc.tab=0)
