...
[링크](https://fe-developers.kakaoent.com/2022/221110-error-boundary) 여기에 있는 코드를 참고해서 하고 있는데, axios error의 경우 이전에 하던 프로젝트는 서버가 다 내려가있는 상태다보니 확인하기 어려울 것 같아서 이후에 프로젝트 하나 더 만들어서 진행해보려고 생각중이다.
